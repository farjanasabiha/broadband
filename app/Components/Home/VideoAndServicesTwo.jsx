          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center justify-between">
            <div className="lg:col-span-5 lg:pr-10">
              ...
              <p className="text-[18px] font-normal text-[#b2b5af]  pb-5">
                ...
                It also offers buffer-less high-quality                 <span className="font-medium bg-gradient-to-r from-[#ff0033] to-[#f39f5a] bg-clip-text text-transparent">
                  4k video
                </span>{" "} conferencing,
...
export default VideoAndServicesTwo;
