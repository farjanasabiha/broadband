  ...
  return (
    <div className="container mx-auto px-5 pb-10 2xl:pb-0">
      <div className="text-center space-y-5 lg:space-y-10">
        <h1 className="font-medium text-4xl md:text-5xl lg:text-8xl text-white leading-30">
        ...
        <div className="text-center mx-auto">
          <button className="py-3 px-8 rounded-3xl font-medium bg-gradient-to-b from-[#ff0033] to-[#bd556a63]">
