...
const HomeInternet = () => {
  ...
  const packagesPlans = [
    {
      id: 1,
      name: t("packages_basic_home"),
      speed: "20 Mbps",
      price: t("packages_basic_home_price"),
      features: [
        { text: t("packages_basic_home_feature1") },
        { text: t("packages_basic_home_feature2") },
        { text: t("packages_basic_home_feature3") },
        { text: t("packages_basic_home_feature4") },
        { text: t("packages_basic_home_feature5") },
        { text: t("packages_basic_home_feature6") },
      ],
    },
    {
      id: 2,
      name: t("packages_premium_home"),
      speed: "50 Mbps",
      price: t("packages_premium_home_price"),
      features: [
        { text: t("packages_premium_home_feature1") },
        { text: t("packages_premium_home_feature2") },
        { text: t("packages_premium_home_feature3") },
        { text: t("packages_premium_home_feature4") },
        { text: t("packages_premium_home_feature5") },
        { text: t("packages_premium_home_feature6") },
        { text: t("packages_premium_home_feature7") },
        { text: t("packages_premium_home_feature8") },
      ],
    },
    {
      id: 3,
      name: t("packages_business_home"),
      speed: "100 Mbps",
      price: t("packages_business_home_price"),
      features: [
        { text: t("packages_business_home_feature1") },
        { text: t("packages_business_home_feature2") },
        { text: t("packages_business_home_feature3") },
        { text: t("packages_business_home_feature4") },
        { text: t("packages_business_home_feature5") },
        { text: t("packages_business_home_feature6") },
        { text: t("packages_business_home_feature7") },
        { text: t("packages_business_home_feature8") },
      ],
    },
    {
      id: 4,
      name: t("packages_enterprise_home"),
      speed: "200 Mbps",
      price: t("packages_enterprise_home_price"),
      features: [
        { text: t("packages_enterprise_home_feature1") },
        { text: t("packages_enterprise_home_feature2") },
        { text: t("packages_enterprise_home_feature3") },
        { text: t("packages_enterprise_home_feature4") },
        { text: t("packages_enterprise_home_feature5") },
        { text: t("packages_enterprise_home_feature6") },
        { text: t("packages_enterprise_home_feature7") },
        { text: t("packages_enterprise_home_feature8") },
      ],
    },
  ];
