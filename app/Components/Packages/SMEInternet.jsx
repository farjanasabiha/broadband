...
const CorporateInternet = () => {
  ...
  const packagesPlans = [
    {
      id: 1,
      name: t("packages_basic_SME"),
      speed: "30 Mbps",
      price: t("packages_basic_SME_price"),
      features: [
        { text: t("packages_basic_SME_feature1") },
        { text: t("packages_basic_SME_feature2") },
        { text: t("packages_basic_SME_feature3") },
        { text: t("packages_basic_SME_feature4") },
        { text: t("packages_basic_SME_feature5") },
        { text: t("packages_basic_SME_feature6") },
      ],
    },
    {
      id: 2,
      name: t("packages_premium_SME"),
      speed: "40 Mbps",
      price: t("packages_premium_SME_price"),
      features: [
        { text: t("packages_premium_SME_feature1") },
        { text: t("packages_premium_SME_feature2") },
        { text: t("packages_premium_SME_feature3") },
        { text: t("packages_premium_SME_feature4") },
        { text: t("packages_premium_SME_feature5") },
        { text: t("packages_premium_SME_feature6") },
        { text: t("packages_premium_SME_feature7") },
        { text: t("packages_premium_SME_feature8") },
      ],
    },
    {
      id: 3,
      name: t("packages_business_SME"),
      speed: "50 Mbps",
      price: t("packages_business_SME_price"),
      features: [
        { text: t("packages_business_SME_feature1") },
        { text: t("packages_business_SME_feature2") },
        { text: t("packages_business_SME_feature3") },
        { text: t("packages_business_SME_feature4") },
        { text: t("packages_business_SME_feature5") },
        { text: t("packages_business_SME_feature6") },
        { text: t("packages_business_SME_feature7") },
        { text: t("packages_business_SME_feature8") },
      ],
    },
  ];
