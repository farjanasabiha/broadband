...
const Privacy = ({ title, des, sections }) => {
  return (
    <div className="container max-w-6xl mx-auto px-5 pb-20">
      <div>
        {/* Main Title */}
        ...
        {/* Main Description */}
        {des && (
          <p className="text-lg font-normal text-[#b2b5af] pb-8">{des}</p>
        )}
        ...
        {sections && sections.length > 0 && (
          <div className="space-y-8">
            {sections.map((sec, idx) => (
              <div key={idx}>
                <h4
                  className="text-xl font-bold text-[#b2b5af] pb-2"
                >
                  {sec.title}
                </h4>
